...
class Control():
    ...
    def aproxima2(self) -> None:
        self.contador +=0.1
        if self.contador >= 45 and self.bandeira == False:
        ...
        print(errox)
        if self.y > 0 and errox < 0.5 and self.bandeira == True:
            self.robot_state = "gira1"
    ...
    def gira1(self) -> None:
        ...
        errox = abs(abs(self.start.x) - abs(self.x))
        if len(self.contours2) > 0 and self.y < 0:
            self.robot_state = "segue"
        if len(self.contours2) == 0 and self.y > 0 and errox < 0.5 and len(self.contoursVerde) == 0:
            self.robot_state = "segue"
    ...
    def segue(self) -> None:
        ...
        if self.y > 0.5:
            ...
            self.bandeira3 == True
        if len(self.contoursVerde) > 0 and self.y > 0 and self.bandeira3 == False:
    ...
    def aproximaVerde(self) -> None:
        ...
        if  erroy < 0 and errox < 0:
            print(len(self.contoursVerde))
            print(self.y-self.pointVerdey)
